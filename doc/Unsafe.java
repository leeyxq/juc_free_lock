 ...
 * Inc.,  Franklin St, Fifth Floor, Boston, MA 0- USA.
 *
 * Please contact Oracle,  Oracle Parkway, Redwood Shores, CA 5 USA
...
public final class Unsafe {
	...
	/**
	 * This method, like all others with -bit offsets, was native in a previous
	 ...
	 * 1.4.
	 * 
	 * @deprecated As of 1.4.1, cast the -bit offset argument to a long. See
	 ...
	 *
	 * <p>
	 * If the native pointer is less than bits wide, it is extended as an
	...
	/**
	 * Returns the offset of a field, truncated to bits. This method is
	 ...
	 * the Sun JVM does not use the most significant bits. However, JVM
	 ...
	 * be ported to such JVMs on -bit platforms must preserve all bits of static
	 * field offsets.
	 * 
	 * @see #getInt(Object, long)
	 */
	 ...
	 * <p>
	 * As of 1.4.1, offsets for fields are represented as long values, although
	 * the Sun JVM does not use the most significant bits. It is hard to imagine
	 * a JVM technology which needs more than a few bits to encode an offset
	 * within a non-array object, However, for consistency with other methods in
	 * this class, this method reports its result as a long value.
	 * 
	 * @see #getInt(Object, long)
	 */
	 ...
	 *         and class loader
	 * @params databytes of a class file
	 ...
	 * representing averages over the last 1, 5, and minutes, respectively.
	 *
